                        ...
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal" action="{{ route('color.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="name" placeholder="Enter your Color Name">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-text-input" class="col-sm-2 form-label">Color Code</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="color" name="code" placeholder="Enter your Color Code">
                                    </div>
                                </div>
                                <div class="mb-3 row">
