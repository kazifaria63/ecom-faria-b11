    ...
    <section id="banner_one">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="hero_img">
                        <img src="{{ asset('/') }}website/assets/img/common/man.png" alt="img" class="wow slideInRight" data-wow-duration="3.0s"
                             data-wow-delay=".3s">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="product_variation_one_boxed img-zoom-hover">
                        <img src="{{ asset('/') }}website/assets/img/offer/woman.png" alt="img" />
                    ...
                    <div class="product_variation_one_boxed img-zoom-hover">
                        <img src="{{ asset('/') }}website/assets/img/offer/woman1.png" alt="img" />
                        <div class="product_var_one_text">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product_variation_one_boxed img-zoom-hover">
                        <img src="{{ asset('/') }}website/assets/img/offer/bag.png" alt="img" />
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product_variation_one_boxed img-zoom-hover">
                        <img src="{{ asset('/') }}website/assets/img/offer/woman4.png" alt="img" />
                        <div class="product_var_one_text">
                            <h2>New</h2>
                    ...
                    <div class="product_variation_one_boxed img-zoom-hover">
                        <img src="{{ asset('/') }}website/assets/img/offer/kids.png" alt="img" />
                        <div class="product_var_one_text">
                            <h2>Hot</h2>
                ...
                <div class="col-lg-12">
                    <div class="tabs_center_button">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li role="presentation"><a data-bs-toggle="tab" href="#!" data-bs-target="#new_arrival" role="tab" class="active">New Arrival</a></li>
                            <li role="presentation"><a data-bs-toggle="tab" data-bs-target="#trending" role="tab" href="#!">Trending</a></li>
                            <li role="presentation"><a data-bs-toggle="tab" data-bs-target="#best_sellers" href="#!">Best Sellers</a></li>
                            <li role="presentation"><a data-bs-toggle="tab" data-bs-target="#featured" href="#!">Featured</a></li>
                            <li role="presentation"><a data-bs-toggle="tab" data-bs-target="#on_sall" href="#!">On sall</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_wrappers_one">
                                            ...
                                            <div class="content">
                                                ...
                                                <span class="price">
                                                    <span class="new">TK. {{$product->selling_price}}</span>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_wrappers_one">
                                            <div class="thumb">
                                                <a href="product-single.html" class="image">
                                                    <img src="{{ asset('/') }}website/assets/img/product-image/product1.png" alt="Product" />
                                                    <img class="hover-image" src="{{ asset('/') }}website/assets/img/product-image/product2.png"
                                                         alt="Product" />
                                                </a>
                                                <span class="badges">
                                                    <span class="new">New</span>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_wrappers_one">
                                            <div class="thumb">
                                                <a href="product-single.html" class="image">
                                                    <img src="{{ asset('/') }}website/assets/img/product-image/product3.png" alt="Product" />
                                                    <img class="hover-image" src="{{ asset('/') }}website/assets/img/product-image/product4.png"
                                                         alt="Product" />
                                                </a>
                                                <span class="badges">
                                                    <span class="new">New</span>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_wrappers_one">
                                            <div class="thumb">
                                                <a href="product-single.html" class="image">
                                                    <img src="{{ asset('/') }}website/assets/img/product-image/product5.png" alt="Product" />
                                                    <img class="hover-image" src="{{ asset('/') }}website/assets/img/product-image/product6.png"
                                                         alt="Product" />
                                                </a>
                                                <span class="badges">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_wrappers_one">
                                            <div class="thumb">
                                                <a href="product-single.html" class="image">
                                                    <img src="{{ asset('/') }}website/assets/img/product-image/product7.png" alt="Product" />
                                                    <img class="hover-image" src="{{ asset('/') }}website/assets/img/product-image/product8.png"
                                                         alt="Product" />
                                                </a>
                                                <span class="badges">
                                                    <span class="new">New</span>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_wrappers_one">
                                            <div class="thumb">
                                                <a href="product-single.html" class="image">
                                                    <img src="{{ asset('/') }}website/assets/img/product-image/product9.png" alt="Product" />
                                                    <img class="hover-image"
                                                         src="{{ asset('/') }}website/assets/img/product-image/product10.png" alt="Product" />
                                                </a>
                                                <span class="badges">
                                                    <span class="new">New</span>
                                                </span>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_wrappers_one">
                                            <div class="thumb">
                                                <a href="product-single.html" class="image">
                                                    <img src="{{ asset('/') }}website/assets/img/product-image/product11.png" alt="Product" />
                                                    <img class="hover-image"
                                                         src="{{ asset('/') }}website/assets/img/product-image/product12.png" alt="Product" />
                                                </a>
                                                <span class="badges">
                                                    <span class="hot">Hot</span>
                                                </span>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_wrappers_one">
                                            <div class="thumb">
                                                <a href="product-single.html" class="image">
                                                    <img src="{{ asset('/') }}website/assets/img/product-image/product13.png" alt="Product" />
                                                    <img class="hover-image"
                                                         src="{{ asset('/') }}website/assets/img/product-image/product14.png" alt="Product" />
                                                </a>
                                                <span class="badges">
                                                    <span class="new">New</span>
                                                </span>
                    ...
                    <div class="todays_slider owl-carousel owl-them">
                        ...
                        <div class="product_wrappers_one">
                            <div class="thumb">
                                <a href="product-single.html" class="image">
                                    <img src="{{ asset('/') }}website/assets/img/product-image/product9.png" alt="Product" />
                                    <img class="hover-image" src="{{ asset('/') }}website/assets/img/product-image/product10.png"
                                         alt="Product" />
                                </a>
                                <span class="badges">
                                    <span class="hot">Hot</span>
            ...
            <div class="row">
                    ...
                    <div class="blog_one_item img-zoom-hover">
                        <div class="blog_one_img">
                            <a href="blog-single.html">
                                <img src="{{ asset('/') }}website/assets/img/blog/post1.png" alt="img" />
                            </a>
                        </div>
                        <div class="blog_text">
                            <h5 class="date_area">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="blog_one_item img-zoom-hover">
                        <div class="blog_one_img">
                            <a href="blog-single.html">
                                <img src="{{ asset('/') }}website/assets/img/blog/post2.png" alt="img" />
                            </a>
                        </div>
                        <div class="blog_text">
                            <h5 class="date_area">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="blog_one_item img-zoom-hover">
                        <div class="blog_one_img">
                            <a href="blog-single.html">
                                <img src="{{ asset('/') }}website/assets/img/blog/post3.png" alt="img" />
                            </a>
                        </div>
                        <div class="blog_text">
                            <h5 class="date_area">
                    ...
                    <div class="instagram_post_slider owl-carousel owl-theme">
                        <div class="instgram_post">
                            <a href="#!">
                                ...
                                <img src="{{ asset('/') }}website/assets/img/instagram/post2.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
                                <i class="fab fa-instagram"></i>
                                <img src="{{ asset('/') }}website/assets/img/instagram/post3.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
                                <i class="fab fa-instagram"></i>
                                <img src="{{ asset('/') }}website/assets/img/instagram/post4.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
                                <i class="fab fa-instagram"></i>
                                <img src="{{ asset('/') }}website/assets/img/instagram/post5.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
                                <i class="fab fa-instagram"></i>
                                <img src="{{ asset('/') }}website/assets/img/instagram/post6.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
                                <i class="fab fa-instagram"></i>
                                <img src="{{ asset('/') }}website/assets/img/instagram/post7.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
                                <i class="fab fa-instagram"></i>
                                <img src="{{ asset('/') }}website/assets/img/instagram/post8.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
                                <i class="fab fa-instagram"></i>
                                <img src="{{ asset('/') }}website/assets/img/instagram/post9.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
                                <i class="fab fa-instagram"></i>
                                <img src="{{ asset('/') }}website/assets/img/instagram/post10.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
                                <i class="fab fa-instagram"></i>
                                <img src="{{ asset('/') }}website/assets/img/instagram/post1.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
                                <i class="fab fa-instagram"></i>
                                <img src="{{ asset('/') }}website/assets/img/instagram/post11.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
                                <i class="fab fa-instagram"></i>
                                <img src="{{ asset('/') }}website/assets/img/instagram/post12.png" alt="img" />
                            </a>
                        </div>
                    </div>
                </div>
