                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product_wrappers_one">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="{{route('product.details', ['id' => $product->id, 'slug' => $product->slug])}}">{{ $product->name }}</a></h5>
                                    <span class="price">
                    ...
                    <div class="shop_sidebar_wrapper">
                        <div class="shop_Search">
                            <form action="#!">
                                ...
                                <button><img src="{{ asset('/') }}website/assets/img/svg/search.svg" alt="img"></button>
                            </form>
                        </div>
